...
//  Date: 01/16/2025
//  Description:  Added Rental Page Logic
//
...
//
  if (rentals.length === 0) {
    return (
      <EmptyList
        heading='There are no rentals to display.'
        message="Create your next rental please."
      />
    );
  }
//
  return (
    <div className='mt-16'>
      <h4 className='mb-4 capitalize'>List of Active Properties : {rentals.length}</h4>
      <Table>
        <TableCaption>Properties listed above reflects current activity of your rentals.</TableCaption>
        <TableHeader>
          <TableRow>
